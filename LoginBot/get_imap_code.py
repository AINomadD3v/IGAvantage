...
def get_instagram_verification_code(
    ...
    try:
        ...
        for folder in folders_to_check:
            ...
            # --- MODIFIED: Reverted to the most reliable search method ---
            # Search for ALL emails and let Python do the filtering. This is
            # more compatible with all IMAP servers.
            if debug:
